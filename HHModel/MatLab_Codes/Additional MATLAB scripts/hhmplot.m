...
cline = 'r';
figure(1);
set(1,'Position',[200 150 620 600],'Color','w');
if ol;
	cindx = rem(numover,6);
	cline = cmap(cindx+1);
...
%set(gca,'Color','k','XColor','k','YColor','k');
xlabel('time (ms)','Color','k'),ylabel('m(t) (dimensionless)','Color','k'),axis([to tf 0 1]);
title('Sodium activation gate','Color','k');
subplot(2,2,3);,plot(t,y(:,3),cline);
%set(gca,'Color','k','XColor','k','YColor','k');
xlabel('time (ms)','Color','k'),ylabel('h(t) (dimensionless)','Color','k'),axis([to tf 0 1]);
title('Sodium inactivation gate','Color','k');
subplot(2,2,4);,plot(t,y(:,4),cline);
%set(gca,'Color','k','XColor','k','YColor','k');
xlabel('time (ms)','Color','k'),ylabel('n(t) (dimensionless)','Color','k'),axis([to tf 0 1]);
title('Potassium gate','Color','k');
